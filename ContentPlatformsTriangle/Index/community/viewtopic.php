...
if (!$auth->acl_get('f_read', $forum_id))
{
	...
	header('Location:/login/'); exit(); //Redirecting to the main login page
	...
	if (!isset($user_cache[$poster_id]))
	{
		if ($poster_id == ANONYMOUS)
		{
			$user_cache[$poster_id] = array(
				...
				'online'			=> false,
				'avatar'			=> ($user->optionget('viewavatars')) ? '<img src="community/Default.png">' : '',
				'rank_title'		=> '',
				'rank_image'		=> '',
				'rank_image_src'	=> '',
				'sig'				=> '',
		...
		else
		{
			...
			$UserID = \Model\UserOperationsModel::IDFromUsername($row['username']);
			...
			$user_cache[$poster_id] = array(
				...
				'avatar'		=> ($user->optionget('viewavatars')) ? '<img class="phpBBAvatarImage" src="' . \Model\UserOperationsModel::getUserAvatarLinkFromUserID($UserID) . '">' : '',
				'age'			=> '',
