...
<link rel="stylesheet" type="text/css" href="/Theme/CSS/bootstrap2.css" />
...
<link rel="shortcut icon" href="http://concernedjoe.com/analytics/favicon.ico" />
</head>
...
<div id="wrap">
	...
	<div id="page-body">
		...
		<?php } if ($this->_rootref['SCRIPT_NAME'] != ('index')) {  if ($this->_rootref['SCRIPT_NAME'] == ('viewforum') || $this->_rootref['SCRIPT_NAME'] == ('viewtopic') || $this->_rootref['SCRIPT_NAME'] == ('faq') || $this->_rootref['SCRIPT_NAME'] == ('search') || $this->_rootref['SCRIPT_NAME'] == ('ucp') || $this->_rootref['SCRIPT_NAME'] == ('memberlist') || $this->_rootref['SCRIPT_NAME'] == ('mcp') || $this->_rootref['SCRIPT_NAME'] == ('posting') || $this->_rootref['SCRIPT_NAME'] == ('report')) {  if ($this->_rootref['SCRIPT_NAME'] != ('posting') && $this->_rootref['SCRIPT_NAME'] != ('report')) {  ?>
							<div class="ForumTitle"><a href="<?php echo (isset($this->_rootref['U_VIEW_FORUM'])) ? $this->_rootref['U_VIEW_FORUM'] : ''; ?>"><?php echo (isset($this->_rootref['FORUM_NAME'])) ? $this->_rootref['FORUM_NAME'] : ''; ?></a></div>
							<div class="ForumDescription"><?php echo (isset($this->_rootref['FORUM_DESC'])) ? $this->_rootref['FORUM_DESC'] : ''; ?></div>
						<?php } } } else { ?>
			<div class="ForumTitle">Keep the conversation going</div>
			<div class="ForumDescription">What did you have for breakfast? No seriously, what did you have for breakfast?</div>
