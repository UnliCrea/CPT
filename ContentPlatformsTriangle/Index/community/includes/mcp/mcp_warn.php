...
class mcp_warn
{
	...
	*/
	function mcp_warn_post_view($action)
	{
		...
		$UserID = \Model\UserOperationsModel::IDFromUsername($user->data['username']);

		get_user_rank($user_row['user_rank'], $user_row['user_posts'], $rank_title, $rank_img, $rank_img_src);
		$avatar_img = '<img class="phpBBAvatarImage" src="' . \Model\UserOperationsModel::getUserAvatarLinkFromUserID($UserID) . '">';
	...
	*/
	function mcp_warn_user_view($action)
	{
		...
		define('IN_PHPBB', true);
		require_once(dirname(__FILE__) . '/../../../index.php');			
		$UserID = \Model\UserOperationsModel::IDFromUsername($user_row['username']);
