...
class EarlyaccessView extends GenericView implements EarlyaccessViewInterface
{
...
'<div id="joe_title">
			<span id="joe_title_text">
				Feel like playing Joe right now?
			</span>
			<br/>
			<span id="joe_subtitle_text">
				Awesome! You can unlock early access to the game right here!
			</span>
		</div>
		...
		<div class="container">
			<div class="left_section">
				...
				<span class="section_text red">
				   <p>
					Keep in mind, this is NOT a finished product! If you plan
					to purchase Early Access, please make sure the email you
					use is the same one as your PayPal account, otherwise the
